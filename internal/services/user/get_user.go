...
func FindUserByEmail(email string) (*models.User, error) {
	...
	err := database.DB.QueryRow("SELECT id, first_name, last_name, password, phone, college, gender, role, country, github, bio, is_banned, is_added, is_vitian, is_verified, team_id WHERE email = $1",
